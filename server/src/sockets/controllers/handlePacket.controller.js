import {storePayload} from '../../redis/redis.js'
...
const handlePacket =  (socket) => {
    ...
    return async (payload) => {
        ...
        try {
            ...
            if (!response) {
                throw new Error('There was an error in storing the payload in Redis');
            }

            socket.emit('fPacket', payload);
            socket.emit('confirmation', {success: true, message: 'Packet received, stored and emitted!'});
