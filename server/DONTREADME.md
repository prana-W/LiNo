...
## Adding AI layer to categorise the Notes/video accordingly - like education, gaming, etc.

## Redis caching for frequent DB queries like fetching public notes information
