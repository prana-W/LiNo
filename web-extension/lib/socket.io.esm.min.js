...
const i = {type: "error", data: "parser error"},
    ...
    o = ({
             type: s,
             data: i
         }, o, c) => e && i instanceof Blob ? o ? c(i) : h(i, c) : n && (i instanceof ArrayBuffer || r(i)) ? o ? c(i) : h(new Blob([i]), c) : c(t[s] + (i || "")),
    h = (t, s) => {
...
const l = "function" == typeof ArrayBuffer, d = (t, e) => {
        ...
        if (l) {
            const i = (t => {
                let s, i, e, n, r, o = .75 * t.length, h = t.length, c = 0;
                "=" === t[t.length - 1] && (o--, "=" === t[t.length - 2] && o--);
                const a = new ArrayBuffer(o), u = new Uint8Array(a);
                for (s = 0; s < h; s += 4) i = f[t.charCodeAt(s)], e = f[t.charCodeAt(s + 1)], n = f[t.charCodeAt(s + 2)], r = f[t.charCodeAt(s + 3)], u[c++] = i << 2 | e >> 4, u[c++] = (15 & e) << 4 | n >> 2, u[c++] = (3 & n) << 6 | 63 & r;
                return a
            })(t);
            return y(i, s)
        }
...
function g() {
    return new TransformStream({
        transform(t, s) {
            !function (t, s) {
                e && t.data instanceof Blob ? t.data.arrayBuffer().then(c).then(s) : n && (t.data instanceof ArrayBuffer || r(t.data)) ? s(c(t.data)) : o(t, !1, (t => {
...
k.prototype.on = k.prototype.addEventListener = function (t, s) {
    ...
    for (var n = 0; n < e.length; n++) if ((i = e[n]) === s || i.fn === s) {
        e.splice(n, 1);
        break
    }
    ...
    this.t = this.t || {};
    for (var s = new Array(arguments.length - 1), i = this.t["$" + t], e = 1; e < arguments.length; e++) s[e - 1] = arguments[e];
    if (i) {
        e = 0;
...
const A = "function" == typeof Promise && "function" == typeof Promise.resolve ? t => Promise.resolve().then(t) : (t, s) => s(t, 0),
...
const _ = E.setTimeout, j = E.clearTimeout;
...
class T extends k {
    constructor(t) {
        super(), this.writable = !1, x(this, t), this.opts = t, this.query = t.query, this.socket = t.socket, this.supportsBinary = !t.forceBase64
    }
    ...
    h(t) {
        const s = function (t) {
            let s = "";
            for (let i in t) t.hasOwnProperty(i) && (s.length && (s += "&"), s += encodeURIComponent(i) + "=" + encodeURIComponent(t[i]));
            return s
        }(t);
        return s.length ? "?" + s : ""
    }
...
class N extends T {
    ...
    pause(t) {
        ...
        if (this.u || !this.writable) {
            let t = 0;
            this.u && (t++, this.once("pollComplete", (function () {
                --t || s()
...
class M extends N {
    constructor(t) {
        if (super(t), "undefined" != typeof location) {
            ...
            let i = location.port;
            i || (i = s ? "443" : "80"), this.xd = "undefined" != typeof location && t.hostname !== location.hostname || i !== t.port
        }
    }

    doWrite(t, s) {
        const i = this.request({method: "POST", data: t});
        i.on("success", s), i.on("error", ((t, s) => {
    ...
    doPoll() {
        ...
        t.on("data", this.onData.bind(this)), t.on("error", ((t, s) => {
...
class S extends k {
    constructor(t, s, i) {
        super(), this.createRequest = t, x(this, i), this.p = i, this.v = i.method || "GET", this.m = s, this.k = void 0 !== i.data ? i.data : null, this.A()
    }

    A() {
        var t;
        const s = O(this.p, "agent", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "autoUnref");
        s.xdomain = !!this.p.xd;
        ...
        try {
            ...
            try {
                if (this.p.extraHeaders) {
                    ...
                    for (let t in this.p.extraHeaders) this.p.extraHeaders.hasOwnProperty(t) && i.setRequestHeader(t, this.p.extraHeaders[t])
                }
            } catch (t) {
            }
            if ("POST" === this.v) try {
            ...
            null === (t = this.p.cookieJar) || void 0 === t || t.addCookies(i), "withCredentials" in i && (i.withCredentials = this.p.withCredentials), this.p.requestTimeout && (i.timeout = this.p.requestTimeout), i.onreadystatechange = () => {
                var t;
                3 === i.readyState && (null === (t = this.p.cookieJar) || void 0 === t || t.parseCookies(i.getResponseHeader("set-cookie"))), 4 === i.readyState && (200 === i.status || 1223 === i.status ? this._() : this.setTimeoutFn((() => {
...
class V extends T {
    ...
    doOpen() {
        const t = this.uri(), s = this.opts.protocols,
    ...
    doOpen() {
        ...
        this.N.closed.then((() => {
            ...
            this.N.createBidirectionalStream().then((t => {
                        ...
                        transform(h, c) {
                            for (e.push(h); ;) {
                                if (0 === n) {
                                    if (v(e) < 1) break;
                                    const t = m(e, 1);
                                    o = !(128 & ~t[0]), r = 127 & t[0], n = r < 126 ? 3 : 126 === r ? 1 : 2
                                } else if (1 === n) {
                                    if (v(e) < 2) break;
                                    const t = m(e, 2);
                                    r = new DataView(t.buffer, t.byteOffset, t.length).getUint16(0), n = 3
                                } else if (2 === n) {
                                    if (v(e) < 8) break;
                                    const t = m(e, 8), s = new DataView(t.buffer, t.byteOffset, t.length),
                                        o = s.getUint32(0);
                ...
                }(Number.MAX_SAFE_INTEGER, this.socket.binaryType), e = t.readable.pipeThrough(s).getReader(), n = g();
                n.readable.pipeTo(t.writable), this.U = n.writable.getWriter();
                const r = () => {
                    e.read().then((({done: t, value: s}) => {
                        t || (this.onPacket(s), r())
                    })).catch((t => {
                    }))
                };
                r();
                const o = {type: "open"};
                this.query.sid && (o.data = `{"sid":"${this.query.sid}"}`), this.U.write(o).then((() => this.onOpen()))
            }))
        }))
    }
...
function Q(t) {
    ...
    return -1 != i && -1 != e && (r.source = s, r.host = r.host.substring(1, r.host.length - 1).replace(/;/g, ":"), r.authority = r.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), r.ipv6uri = !0), r.pathNames = function (t, s) {
        const i = /\/{2,9}/g, e = s.replace(i, "/").split("/");
...
const G = "function" == typeof addEventListener && "function" == typeof removeEventListener, K = [];
...
class Y extends k {
    constructor(t, s) {
        if (super(), this.binaryType = "arraybuffer", this.writeBuffer = [], this.P = 0, this.D = -1, this.M = -1, this.S = -1, this.L = 1 / 0, t && "object" == typeof t && (s = t, t = null), t) {
            const i = Q(t);
            s.hostname = i.host, s.secure = "https" === i.protocol || "wss" === i.protocol, s.port = i.port, i.query && (s.query = i.query)
        } else s.host && (s.hostname = Q(s.host).host);
        x(this, s), this.secure = null != s.secure ? s.secure : "undefined" != typeof location && "https:" === location.protocol, s.hostname && !s.port && (s.port = this.secure ? "443" : "80"), this.hostname = s.hostname || ("undefined" != typeof location ? location.hostname : "localhost"), this.port = s.port || ("undefined" != typeof location && location.port ? location.port : this.secure ? "443" : "80"), this.transports = [], this.R = {}, s.transports.forEach((t => {
        ...
        }, s), this.opts.path = this.opts.path.replace(/\/$/, "") + (this.opts.addTrailingSlash ? "/" : ""), "string" == typeof this.opts.query && (this.opts.query = function (t) {
            let s = {}, i = t.split("&");
            ...
            return s
        }(this.opts.query)), G && (this.opts.closeOnBeforeunload && (this.I = () => {
            this.transport && (this.transport.removeAllListeners(), this.transport.close())
        }, addEventListener("beforeunload", this.I, !1)), "localhost" !== this.hostname && (this.F = () => {
            this.$("transport close", {description: "network connection lost"})
        }, K.push(this.F))), this.opts.withCredentials && (this.V = void 0), this.H()
    }
    ...
    H() {
        ...
        const t = this.opts.rememberUpgrade && Y.priorWebsocketSuccess && -1 !== this.transports.indexOf("websocket") ? "websocket" : this.transports[0];
    ...
    setTransport(t) {
        this.transport && this.transport.removeAllListeners(), this.transport = t, t.on("drain", this.W.bind(this)).on("packet", this.q.bind(this)).on("error", this.j.bind(this)).on("close", (t => this.$("transport close", t)))
    }
    ...
    J() {
        ...
        this.L = Date.now() + t, this.G = this.setTimeoutFn((() => {
            this.$("ping timeout")
    ...
    K() {
        ...
        for (let i = 0; i < this.writeBuffer.length; i++) {
            ...
            if (e && (t += "string" == typeof (s = e) ? function (t) {
                let s = 0, i = 0;
                for (let e = 0, n = t.length; e < n; e++) s = t.charCodeAt(e), s < 128 ? i += 1 : s < 2048 ? i += 2 : s < 55296 || s >= 57344 ? i += 3 : (e++, i += 4);
                return i
            }(s) : Math.ceil(1.33 * (s.byteLength || s.size))), i > 0 && t > this.S) return this.writeBuffer.slice(0, i);
            t += 2
        }
        var s;
...
class Z extends Y {
    ...
    onOpen() {
        if (super.onOpen(), "open" === this.readyState && this.opts.upgrade) for (let t = 0; t < this.Z.length; t++) this.tt(this.Z[t])
    }

    tt(t) {
        let s = this.createTransport(t), i = !1;
        Y.priorWebsocketSuccess = !1;
        const e = () => {
            i || (s.send([{type: "ping", data: "probe"}]), s.once("packet", (t => {
                if (!i) if ("pong" === t.type && "probe" === t.data) {
                    if (this.upgrading = !0, this.emitReserved("upgrading", s), !s) return;
                    Y.priorWebsocketSuccess = "websocket" === s.name, this.transport.pause((() => {
                        i || "closed" !== this.readyState && (a(), this.setTransport(s), s.send([{type: "upgrade"}]), this.emitReserved("upgrade", s), s = null, this.upgrading = !1, this.flush())
                    }))
                } else {
        ...
        const a = () => {
            s.removeListener("open", e), s.removeListener("error", r), s.removeListener("close", o), this.off("close", h), this.off("upgrading", c)
        };
        s.once("open", e), s.once("error", r), s.once("close", o), this.once("close", h), this.once("upgrading", c), -1 !== this.Z.indexOf("webtransport") && "webtransport" !== t ? this.setTimeoutFn((() => {
            i || s.open()
        }), 200) : s.open()
    }
...
class tt extends Z {
    constructor(t, s = {}) {
        ...
        (!i.transports || i.transports && "string" == typeof i.transports[0]) && (i.transports = (i.transports || ["polling", "websocket", "webtransport"]).map((t => X[t])).filter((t => !!t))), super(t, i)
    }
}
...
class st extends N {
    ...
    it(t) {
        var s;
        const i = void 0 !== t, e = new Headers(this.opts.extraHeaders);
...
function lt(t, s) {
    ...
    if (Array.isArray(t)) for (let i = 0; i < t.length; i++) t[i] = lt(t[i], s); else if ("object" == typeof t) for (const i in t) Object.prototype.hasOwnProperty.call(t, i) && (t[i] = lt(t[i], s));
    return t
}

const dt = ["connect", "connect_error", "disconnect", "disconnecting", "newListener", "removeListener"], pt = 5;
var yt;
!function (t) {
...
class bt extends k {
    ...
    add(t) {
        ...
        if ("string" == typeof t) {
            ...
            i || s.type === yt.BINARY_ACK ? (s.type = i ? yt.EVENT : yt.ACK, this.reconstructor = new gt(s), 0 === s.attachments && super.emitReserved("decoded", s)) : super.emitReserved("decoded", s)
        } else {
...
var mt = Object.freeze({
    __proto__: null, protocol: 5, get PacketType() {
        ...
        encode(t) {
            return t.type !== yt.EVENT && t.type !== yt.ACK || !ct(t) ? [this.encodeAsString(t)] : this.encodeAsBinary({
        ...
        encodeAsString(t) {
            let s = "" + t.type;
            return t.type !== yt.BINARY_EVENT && t.type !== yt.BINARY_ACK || (s += t.attachments + "-"), t.nsp && "/" !== t.nsp && (s += t.nsp + ","), null != t.id && (s += t.id), null != t.data && (s += JSON.stringify(t.data, this.replacer)), s
        }

        encodeAsBinary(t) {
            const s = at(t), i = this.encodeAsString(s.packet), e = s.buffers;
            return e.unshift(i), e
        }
    }, Decoder: bt, isPacketValid: function (t) {
...
class Et extends k {
    constructor(t, s, i) {
        super(), this.connected = !1, this.recovered = !1, this.receiveBuffer = [], this.sendBuffer = [], this.nt = [], this.rt = 0, this.ids = 0, this.acks = {}, this.flags = {}, this.io = t, this.nsp = s, i && i.auth && (this.auth = i.auth), this.p = Object.assign({}, i), this.io.ot && this.open()
    }
    ...
    emit(t, ...s) {
        ...
        if (r.options.compress = !1 !== this.flags.compress, "function" == typeof s[s.length - 1]) {
            const t = this.ids++, i = s.pop();
            this.ft(t, i), r.id = t
        }
        const o = null === (e = null === (i = this.io.engine) || void 0 === i ? void 0 : i.transport) || void 0 === e ? void 0 : e.writable,
    ...
    ut(t) {
        ...
        const i = {id: this.rt++, tryCount: 0, pending: !1, args: t, flags: Object.assign({fromQueue: !0}, this.flags)};
        t.push(((t, ...e) => {
            if (i !== this.nt[0]) return;
            return null !== t ? i.tryCount > this.p.retries && (this.nt.shift(), s && s(t)) : (this.nt.shift(), s && s(null, ...e)), i.pending = !1, this.lt()
    ...
    emitEvent(t) {
        ...
        super.emit.apply(this, t), this.bt && t.length && "string" == typeof t[t.length - 1] && (this.gt = t[t.length - 1])
    }
...
Ot.prototype.duration = function () {
    ...
    if (this.jitter) {
        var s = Math.random(), i = Math.floor(s * this.jitter * t);
...
class _t extends k {
    constructor(t, s) {
        var i;
        super(), this.nsps = {}, this.subs = [], t && "object" == typeof t && (s = t, t = void 0), (s = s || {}).path = s.path || "/socket.io", this.opts = s, x(this, s), this.reconnection(!1 !== s.reconnection), this.reconnectionAttempts(s.reconnectionAttempts || 1 / 0), this.reconnectionDelay(s.reconnectionDelay || 1e3), this.reconnectionDelayMax(s.reconnectionDelayMax || 5e3), this.randomizationFactor(null !== (i = s.randomizationFactor) && void 0 !== i ? i : .5), this.backoff = new Ot({
            min: this.reconnectionDelay(),
            max: this.reconnectionDelayMax(),
            jitter: this.randomizationFactor()
        }), this.timeout(null == s.timeout ? 2e4 : s.timeout), this.ct = "closed", this.uri = t;
        const e = s.parser || mt;
        this.encoder = new e.Encoder, this.decoder = new e.Decoder, this.ot = !1 !== s.autoConnect, this.ot && this.open()
    }
    ...
    open(t) {
        ...
        const s = this.engine, i = this;
        this.ct = "opening", this.skipReconnect = !1;
        const e = kt(s, "open", (function () {
            i.onopen(), t && t()
        })), n = s => {
            this.cleanup(), this.ct = "closed", this.emitReserved("error", s), t ? t(s) : this.maybeReconnectOnOpen()
        }, r = kt(s, "error", n);
        if (!1 !== this.Bt) {
            const t = this.Bt, i = this.setTimeoutFn((() => {
...
function xt(t, s) {
    ...
    }(t, (s = s || {}).path || "/socket.io"), e = i.source, n = i.id, r = i.path, o = jt[n] && r in jt[n].nsps;
    let h;
